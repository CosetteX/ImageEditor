...
public:
    ...
    std::shared_ptr<ICommandBase> GetZoomCommand();
    ...
    void ExecZoomCommand(double sx, double sy);
    void ExecZoomInCommand();
    void ExecZoomOutCommand();
    void ExecResetZoomCommand();
...
private:
    ...
    std::shared_ptr<ZoomCommand> zoomCommand;
